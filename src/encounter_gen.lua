...
-- Encounter tables by disposition
local friendly_encounters = {
...
-- Encounter chance by chamber type
local encounter_chances = {
    [1] = 30,  -- Empty room
    [2] = 60,  -- Treasure room
    [3] = 90,  -- Monster lair
    [4] = 20,  -- Trap room
...
-- Encounter disposition weights by chamber type
local disposition_weights = {
